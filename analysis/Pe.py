# Calculating electron gas quantities
...
# Import winds and check relative importance of pressures (check for low and high Mdot)
# from IO import read_from_file

# R_175, _, _, rho_175, T_175, P_175, _, _, _, _, _, _ = read_from_file(17.5)
# R_19, _, _, rho_19, T_19, P_19, _, _, _, _, _, _ = read_from_file(19.0)

# fig,(ax1,ax2) = plt.subplots(1,2,figsize=(15,8))
# ax1.set_title(r'log $\dot{M}=17.5$')
# ax2.set_title(r'log $\dot{M}=19$')
# ax1.set_xlabel(r'$\rho$ (g cm$^{-3}$)')
# ax2.set_xlabel(r'$\rho$ (g cm$^{-3}$)')
# ax1.set_ylabel(r'Pressure (dyne cm$^{-2}$)')

# ax1.loglog(rho_175,P_175,label='Total')
# ax2.loglog(rho_19,P_19,label='Total')
# plt.show()
